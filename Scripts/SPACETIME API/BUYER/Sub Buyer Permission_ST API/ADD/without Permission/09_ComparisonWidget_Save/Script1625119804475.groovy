...
WebUI.waitForElementVisible(findTestObject('CONSUMER/Evaluation Widget/button_Save'), 0)

WebUI.verifyElementPresent(findTestObject('CONSUMER/Evaluation Widget/button_Save'), 0)

WebUI.verifyElementNotClickable(findTestObject('CONSUMER/Evaluation Widget/button_Save'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('CONSUMER/Evaluation Widget/button_Save'), FailureHandling.STOP_ON_FAILURE)
