...
WebUI.waitForElementVisible(findTestObject('CONSUMER/Cart/button_Delete'), 0)

WebUI.verifyElementPresent(findTestObject('CONSUMER/Cart/button_Delete'), 0)

WebUI.verifyElementNotClickable(findTestObject('CONSUMER/Cart/button_Delete'), FailureHandling.STOP_ON_FAILURE)
