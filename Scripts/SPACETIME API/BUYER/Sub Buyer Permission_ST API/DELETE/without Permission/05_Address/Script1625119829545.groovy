...
WebUI.verifyElementPresent(findTestObject('CONSUMER/Settings/button_delete'), 0)

WebUI.verifyElementNotClickable(findTestObject('CONSUMER/Settings/button_delete'))
