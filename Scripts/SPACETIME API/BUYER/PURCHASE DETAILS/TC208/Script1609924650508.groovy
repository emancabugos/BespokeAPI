...
WebUI.waitForElementVisible(findTestObject('SPACETIME API/BUYER/Purchase Order Details/Page_Bespoke API  Purchase Order Details/Booking Details/textlabel_unit'), 
    0)

WebUI.waitForElementVisible(findTestObject('SPACETIME API/BUYER/Purchase Order Details/Page_Bespoke API  Purchase Order Details/Booking Details/textlabel_unit'), 
    0)

WebUI.waitForElementVisible(findTestObject('SPACETIME API/BUYER/Purchase Order Details/Page_Bespoke API  Purchase Order Details/Booking Details/textlabel__Add-ons'), 
    0)

WebUI.waitForElementPresent(findTestObject('SPACETIME API/BUYER/Purchase Order Details/Page_Bespoke API  Purchase Order Details/Booking Details/textlabel__Add-ons'), 
    0)
...
String unittextlabel = WebUI.getText(findTestObject('SPACETIME API/BUYER/Purchase Order Details/Page_Bespoke API  Purchase Order Details/Booking Details/textlabel_unit'))
...
String valueunit = WebUI.getText(findTestObject('SPACETIME API/BUYER/Purchase Order Details/Page_Bespoke API  Purchase Order Details/Booking Details/textlabelValue_unit'))

String addonsvalue = WebUI.getText(findTestObject('SPACETIME API/BUYER/Purchase Order Details/Page_Bespoke API  Purchase Order Details/Booking Details/textlabelValue_Addons'))

WebUI.verifyMatch(durationtextlabel, 'No. of Hour:', false)

WebUI.verifyMatch(unittextlabel, 'No. of Day:', false)
...
WebUI.verifyMatch(valueunit, '', false)

WebUI.verifyMatch(addonsvalue, '', false)
