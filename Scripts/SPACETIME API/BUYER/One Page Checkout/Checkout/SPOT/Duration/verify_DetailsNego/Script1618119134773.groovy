...
def fsubtotal = WebUI.getText(findTestObject('SPACETIME API/BUYER/One Page Checkout/a_Order Total/textlabelvalue_SubTotal'))
...
//Deduct discount 
BigDecimal intsubtotal = new BigDecimal(fsubtotalTmp.text)
...
def total = inttotal2 + intdelivery
