...
WebUI.verifyElementText(findTestObject('SPACETIME API/MERCHANT/Create Quotation/a_Quotation Price/value_Discount'), '5.00')
...
WebUI.selectOptionByValue(findTestObject('SPACETIME API/MERCHANT/Create Quotation/a_Discount/dropdown_Reason1'), 'Quantity Discount', 
    false)
...
WebUI.selectOptionByValue(findTestObject('SPACETIME API/MERCHANT/Create Quotation/a_Discount/dropdown_DiscountType1'), 'Percentage', 
    false)
...
WebUI.selectOptionByValue(findTestObject('SPACETIME API/MERCHANT/Create Quotation/a_Charges/dropdown_Reason2'), 'Freight Costs', 
    false)
