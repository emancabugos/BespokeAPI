...
WebUI.setText(findTestObject('SPACETIME API/MERCHANT/Create Listing/textbox_Item Description'), 'ITEM DESCRIPTION !@#123')

WebUI.verifyElementAttributeValue(findTestObject('SPACETIME API/MERCHANT/Create Listing/textbox_Item Description'), 'value', 
    'ITEM DESCRIPTION !@#123', 0)
