...
WebUI.waitForElementVisible(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/timePicker_mondEnd'), 0)

WebUI.verifyElementClickable(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/timePicker_mondEnd'), FailureHandling.CONTINUE_ON_FAILURE)
