...
WebUI.click(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/icon_deleteBlocked'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementNotPresent(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/text_blockedDates'), 0)
