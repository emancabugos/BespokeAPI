...
WebUI.waitForElementVisible(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/icon_previousCalendar'), 0)

WebUI.verifyElementClickable(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/icon_previousCalendar'), FailureHandling.CONTINUE_ON_FAILURE)
