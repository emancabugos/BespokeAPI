...
WebUI.waitForElementVisible(findTestObject('SPACETIME API/MERCHANT/Create Listing/textbox_Choose end date'), 0)

WebUI.verifyElementClickable(findTestObject('SPACETIME API/MERCHANT/Create Listing/textbox_Choose end date'), FailureHandling.CONTINUE_ON_FAILURE)
