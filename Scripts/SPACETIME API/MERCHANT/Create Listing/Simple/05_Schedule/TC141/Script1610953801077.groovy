...
WebUI.waitForElementVisible(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/calendar_week'), 0)

WebUI.verifyElementClickable(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/calendar_week'), FailureHandling.CONTINUE_ON_FAILURE)
