...
WebUI.waitForElementVisible(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/timePicker_monStart'), 0)

WebUI.verifyElementClickable(findTestObject('SPACETIME API/MERCHANT/Create Listing/04_Sched/timePicker_monStart'), FailureHandling.CONTINUE_ON_FAILURE)
