...
WebUI.setText(findTestObject('SPACETIME API/MERCHANT/Create Listing/textbox_listingName'), 'per Custom 150min 24/7 Duration')
...
WebUI.uploadFile(findTestObject('SPACETIME API/MERCHANT/Create Listing/03_Add Image/img_container'), 'C:\\\\Katalon\\\\BespokeAPI\\\\Images\\\\UN Items\\\\item1.jpg')
