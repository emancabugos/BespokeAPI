...
WebUI.verifyElementPresent(findTestObject('CONSUMER/Cart/button_Edit'), 0)

WebUI.verifyElementNotClickable(findTestObject('CONSUMER/Cart/button_Edit'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('CONSUMER/Cart/button_Edit'), FailureHandling.STOP_ON_FAILURE)
