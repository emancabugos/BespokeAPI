...
WebUI.setText(findTestObject('SPACETIME API/BUYER/Homepage/textfield_search'), 'per Custom 1day 24/7 D')
...
WebUI.verifyElementText(findTestObject('SPACETIME API/CONSUMER/Search Result/text_serviceName'), 'per Custom 1day 24/7 D')
