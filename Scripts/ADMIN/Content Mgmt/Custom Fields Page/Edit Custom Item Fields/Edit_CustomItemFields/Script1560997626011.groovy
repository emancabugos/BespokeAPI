...
WebUI.click(findTestObject('ADMIN/Custom Item Fields List Page/sidemenu_configuration'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('ADMIN/Custom Item Fields List Page/button_Edit'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Custom Item Fields Page/a_Default/dropdown_fieldtype'), 0)

WebUI.selectOptionByLabel(findTestObject('ADMIN/Custom Item Fields Page/a_Default/dropdown_fieldtype'), 'Textfield', false)

WebUI.waitForElementVisible(findTestObject('ADMIN/Custom Item Fields Page/a_Textfield/togglebutton_SearchbyField'), 0)

WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Default/textfield_fieldname'), '')
