...
WebUI.click(findTestObject('CONSUMER/Evaluation Widget/a_Delete/button_delete'))

WebUI.waitForElementVisible(findTestObject('CONSUMER/Evaluation Widget/a_Delete/button_Okay'), 0)

WebUI.click(findTestObject('CONSUMER/Evaluation Widget/a_Delete/button_DCancel'))
