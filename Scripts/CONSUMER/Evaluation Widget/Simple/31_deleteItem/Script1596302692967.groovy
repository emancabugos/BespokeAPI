...
WebUI.click(findTestObject('CONSUMER/Evaluation Widget/a_Delete/button_Okay'))
...
WebUI.verifyElementNotVisible(findTestObject('CONSUMER/Evaluation Widget/a_Delete/button_delete'))
