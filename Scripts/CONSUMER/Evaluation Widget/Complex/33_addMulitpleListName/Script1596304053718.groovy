...
WebUI.setText(findTestObject('CONSUMER/Evaluation Widget/textfield_ListName'), listNameWidget)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('CONSUMER/Evaluation Widget/dropdown_ListName'), listNameWidget, false, 
    0)
