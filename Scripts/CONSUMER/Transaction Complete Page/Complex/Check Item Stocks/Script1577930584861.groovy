...
WebUI.click(findTestObject('CONSUMER/Transaction Complete Page/linktext_ReturnHome'))
...
WebUI.comment('Add first an expected value')

WebUI.verifyMatch(stockvaluesafter, '', false)
