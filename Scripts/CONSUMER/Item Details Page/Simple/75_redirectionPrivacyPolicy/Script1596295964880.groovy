...
WebUI.callTestCase(findTestCase('CONSUMER/Item Details Page/a_navigateToItemDetails'), [('itemName') : findTestData('CONSUMER/Item Details Page').getValue(
...
WebUI.click(findTestObject('CONSUMER/Footer/linktext_PRIVACY'), FailureHandling.CONTINUE_ON_FAILURE)
