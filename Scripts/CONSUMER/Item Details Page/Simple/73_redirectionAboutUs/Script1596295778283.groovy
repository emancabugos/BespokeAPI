...
WebUI.callTestCase(findTestCase('CONSUMER/Item Details Page/a_navigateToItemDetails'), [('itemName') : findTestData(null).getValue(
...
WebUI.click(findTestObject('CONSUMER/Footer/linktext_ABOUT'), FailureHandling.CONTINUE_ON_FAILURE)
