...
WebUI.verifyElementClickable(findTestObject('CONSUMER/Search Result Page/textlabel_Price'))

WebUI.click(findTestObject('CONSUMER/Search Result Page/textlabel_Price'))
