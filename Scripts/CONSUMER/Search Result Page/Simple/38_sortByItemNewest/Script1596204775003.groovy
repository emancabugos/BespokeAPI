...
WebUI.selectOptionByLabel(findTestObject('CONSUMER/Search Result Page/dropdown_Sort'), 'Item-Newest', false)

WebUI.delay(1)

WebUI.verifyElementText(findTestObject('CONSUMER/Search Result Page/itemName_SearchResultPage'), itemResultNewest)
