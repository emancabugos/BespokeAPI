...
WebUI.verifyElementClickable(findTestObject('CONSUMER/Search Result Page/linktext_SellerName'))

WebUI.click(findTestObject('CONSUMER/Search Result Page/linktext_SellerName'))
