...
WebUI.setText(findTestObject('CONSUMER/Evaluation List/Add Edit Popup/textbox_name'), listNameList)

WebUI.delay(1)

WebUI.click(findTestObject('CONSUMER/Evaluation List/Add Edit Popup/button_Save'), FailureHandling.CONTINUE_ON_FAILURE)
