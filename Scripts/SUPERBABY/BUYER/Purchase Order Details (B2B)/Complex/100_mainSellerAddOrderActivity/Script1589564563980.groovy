...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Purchase Order Main Seller')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Production Main Seller')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Shipping Main Seller')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Finance Main Seller')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Certification Main Seller')
