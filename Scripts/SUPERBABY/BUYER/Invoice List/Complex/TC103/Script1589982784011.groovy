...
'Search Invoice No & All Supplier'
WebUI.setText(findTestObject('SUPERBABY/BUYER/Invoice List/textbox_search'), '')

WebUI.click(findTestObject('SUPERBABY/BUYER/Invoice List/ddicon_supplier'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('SUPERBABY/BUYER/Invoice List/tickbox_Select All_supplier'), 0)

WebUI.click(findTestObject('SUPERBABY/BUYER/Invoice List/tickbox_Select All_supplier'), FailureHandling.STOP_ON_FAILURE)
