...
'Select All Payment Status'
WebUI.waitForElementPresent(findTestObject('SUPERBABY/BUYER/Invoice List/dd_timestamp'), 0)

WebUI.click(findTestObject('SUPERBABY/BUYER/Invoice List/ddicon_status'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('SUPERBABY/BUYER/Invoice List/tickbox_Select All_PaymentStatus'), 0)

'Waiting for data'
WebUI.click(findTestObject('SUPERBABY/BUYER/Invoice List/tickbox_Select All_PaymentStatus'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('SUPERBABY/BUYER/Invoice List/text_apply'), FailureHandling.CONTINUE_ON_FAILURE)
