...
'Select All Payment Due\r\n\r\n'
WebUI.waitForElementPresent(findTestObject('SUPERBABY/BUYER/Invoice List/dd_timestamp'), 0)

WebUI.click(findTestObject('SUPERBABY/BUYER/Invoice List/ddicon_paymentdue'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('SUPERBABY/BUYER/Invoice List/tickbox_Select All_PaymentDue'), 0)

WebUI.click(findTestObject('SUPERBABY/BUYER/Invoice List/tickbox_Select All_PaymentDue'), FailureHandling.STOP_ON_FAILURE)
