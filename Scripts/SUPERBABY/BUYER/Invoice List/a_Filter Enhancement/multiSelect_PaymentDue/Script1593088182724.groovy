...
WebUI.click(findTestObject('SUPERBABY/BUYER/Invoice List/tickbox_Past_PaymentDue'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('SUPERBABY/BUYER/Invoice List/tickbox_Upcoming_PaymentDue'), 0)
