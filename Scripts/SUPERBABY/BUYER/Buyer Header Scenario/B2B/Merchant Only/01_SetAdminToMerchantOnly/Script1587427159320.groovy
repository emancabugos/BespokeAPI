...
if (WebUI.verifyElementNotVisible(findTestObject('Object Repository/ADMIN/Private Settings/Private Settings On UI/button_View Buyer List'), 
    false, FailureHandling.CONTINUE_ON_FAILURE)) {
    WebUI.waitForElementVisible(findTestObject('ADMIN/Private Settings/Private Settings On UI/button_View Buyer List'), 
        0)

    WebUI.acceptAlert()

    WebUI.click(findTestObject('ADMIN/Private Settings/Private Settings On UI/button_Configure Settings'), FailureHandling.STOP_ON_FAILURE)
