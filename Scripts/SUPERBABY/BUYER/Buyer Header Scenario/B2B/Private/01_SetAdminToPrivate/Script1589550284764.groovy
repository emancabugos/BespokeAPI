...
WebUI.waitForElementVisible(findTestObject('ADMIN/Private Settings/span_All Guest Users'), 0)

WebUI.click(findTestObject('ADMIN/Private Settings/span_All Guest Users'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('ADMIN/Private Settings/textbox_page title'), 'All Users Private')

WebUI.setText(findTestObject('ADMIN/Private Settings/textbox_about us'), 'All Users Private')
