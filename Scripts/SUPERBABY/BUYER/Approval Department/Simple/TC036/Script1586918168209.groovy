...
WebUI.waitForElementPresent(findTestObject('SUPERBABY/BUYER/Approval Department/icon_edit'), 0)

WebUI.click(findTestObject('SUPERBABY/BUYER/Approval Department/icon_edit'), FailureHandling.STOP_ON_FAILURE)
