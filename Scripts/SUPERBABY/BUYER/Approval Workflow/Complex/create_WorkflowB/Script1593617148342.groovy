...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Approval Workflow/Create Workflow/textbox_Reason_workflow_name'), 'Approval - Workflow B')
...
WebUI.click(findTestObject('SUPERBABY/BUYER/Approval Workflow/Create Workflow/checkobox_veto2'))
