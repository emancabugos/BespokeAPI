...
WebUI.verifyElementNotClickable(findTestObject('SUPERBABY/BUYER/Buyer User Groups List/linktext_AddNewUserGroups'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('SUPERBABY/BUYER/Buyer User Groups List/linktext_AddNewUserGroups'), FailureHandling.STOP_ON_FAILURE)
