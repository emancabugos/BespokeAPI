...
WebUI.waitForElementVisible(findTestObject('CONSUMER/Evaluation Table/linktext_ClearAll'), 0)

WebUI.verifyElementPresent(findTestObject('CONSUMER/Evaluation Table/linktext_ClearAll'), 0)

WebUI.verifyElementNotClickable(findTestObject('CONSUMER/Evaluation Table/linktext_ClearAll'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('CONSUMER/Evaluation Table/linktext_ClearAll'), FailureHandling.STOP_ON_FAILURE)
