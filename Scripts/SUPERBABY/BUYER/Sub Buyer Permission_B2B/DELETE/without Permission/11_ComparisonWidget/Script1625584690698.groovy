...
WebUI.verifyElementNotClickable(findTestObject('CONSUMER/Evaluation Widget/a_Delete/button_delete'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('CONSUMER/Evaluation Widget/a_Delete/button_delete'), FailureHandling.STOP_ON_FAILURE)
