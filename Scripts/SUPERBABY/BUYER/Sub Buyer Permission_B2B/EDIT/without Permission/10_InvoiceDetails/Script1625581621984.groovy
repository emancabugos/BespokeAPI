...
WebUI.verifyElementNotClickable(findTestObject('SUPERBABY/BUYER/Invoice Details/button_Pay this Invoice'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('SUPERBABY/BUYER/Invoice Details/button_Pay this Invoice'), FailureHandling.STOP_ON_FAILURE)
