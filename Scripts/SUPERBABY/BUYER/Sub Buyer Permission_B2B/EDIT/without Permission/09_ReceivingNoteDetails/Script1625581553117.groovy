...
WebUI.scrollToElement(findTestObject('SUPERBABY/BUYER/Receiving Notes Details/button_VoidReceipt'), 0)

WebUI.verifyElementNotClickable(findTestObject('SUPERBABY/BUYER/Receiving Notes Details/button_VoidReceipt'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('SUPERBABY/BUYER/Receiving Notes Details/button_VoidReceipt'), FailureHandling.STOP_ON_FAILURE)
