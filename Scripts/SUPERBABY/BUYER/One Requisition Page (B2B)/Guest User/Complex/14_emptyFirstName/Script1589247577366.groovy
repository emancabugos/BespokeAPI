...
WebUI.clearText(findTestObject('SUPERBABY/BUYER/One Page Requisition/textfield_FirstName'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/One Page Requisition/textfield_Email'), 'janeDoe@yopmail.com')

WebUI.click(findTestObject('SUPERBABY/BUYER/One Page Requisition/button_SendRequest'), FailureHandling.STOP_ON_FAILURE)

String errornotif = WebUI.getCSSValue(findTestObject('SUPERBABY/BUYER/One Page Requisition/textfield_FirstName'), 'border-color')
