...
WebUI.clearText(findTestObject('SUPERBABY/BUYER/One Page Requisition/textfield_Contact'), FailureHandling.STOP_ON_FAILURE)
...
String errornotif = WebUI.getCSSValue(findTestObject('SUPERBABY/BUYER/One Page Requisition/textfield_Contact'), 'border-color')
