...
WebUI.clearText(findTestObject('SUPERBABY/BUYER/One Page Requisition/textfield_LastName'), FailureHandling.STOP_ON_FAILURE)
...
String errornotif = WebUI.getCSSValue(findTestObject('SUPERBABY/BUYER/One Page Requisition/textfield_LastName'), 'border-color')
