...
String errornotifTime = WebUI.getCSSValue(findTestObject('SUPERBABY/BUYER/Create Receiving Notes/textfield_QuantityReceived'), 
    'border-color')

KeywordLogger log = new KeywordLogger()

log.logInfo(errornotifTime)

WebUI.verifyMatch(errornotifTime, 'rgb(202, 11, 11)', false)
