...
WebUI.click(findTestObject('SUPERBABY/BUYER/Buyer Sidebar/linktext_AccountList'))

WebUI.waitForElementVisible(findTestObject('SUPERBABY/BUYER/Account List/textlink_Invite Buyer Sub-Account'), 0)
