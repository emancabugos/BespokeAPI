...
WebUI.selectOptionByLabel(findTestObject('SUPERBABY/SELLER/Create Quotation/dropdown_QTY'), 'Fixed', false)

WebUI.setText(findTestObject('SUPERBABY/SELLER/Create Quotation/textfield_PricePerUnit'), '8.90')
