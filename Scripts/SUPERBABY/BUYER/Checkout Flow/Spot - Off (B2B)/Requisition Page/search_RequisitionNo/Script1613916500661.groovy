...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Requisition Order List/textfield_Search'), prnumTmp.text)

WebUI.sendKeys(findTestObject('SUPERBABY/BUYER/Requisition Order List/textfield_Search'), Keys.chord(Keys.ENTER))
