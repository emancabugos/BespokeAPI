...
WebUI.verifyElementText(findTestObject('SUPERBABY/BUYER/Requisition Order List/textlabelValue_RequisitionNo'), prnumTmp.text)

WebUI.verifyElementText(findTestObject('SUPERBABY/BUYER/Requisition Order List/textlabelValue_Status'), 'Approved')
