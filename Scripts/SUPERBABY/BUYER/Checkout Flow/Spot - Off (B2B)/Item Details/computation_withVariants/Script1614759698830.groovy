...
def itemprice = WebUI.getText(findTestObject('CONSUMER/Item Details Page/textlabelvalue_ItemPriceVar'))
...
asubtotal = WebUI.getText(findTestObject('CONSUMER/Item Details Page/textlabelvalue_SubTotalVariants'))
