...
def fsub = intitemprice * intqty

println(df.format(new BigDecimal(fsub)))

def fsubtotal = fsub - 2

println(df.format(new BigDecimal(fsubtotal)))

asubtotal = WebUI.getText(findTestObject('CONSUMER/Item Details Page/textlabel_SubTotalBulk'))
