...
File fsubtotalTmp = tmpDir.resolve('fsubtotal1.txt').toFile()
...
BigDecimal intfsubtotal1 = new BigDecimal(fsubtotal1Tmp.text)

BigDecimal intfsubtotal2 = new BigDecimal(fsubtotal2Tmp.text)

def fsubtotal = intfsubtotal1 + intfsubtotal2
