...
def fsubtotal1 = intitemprice * intqty

fsubtotal1Tmp.text = fsubtotal1

println(df.format(new BigDecimal(fsubtotal1)))

asubtotal = WebUI.getText(findTestObject('SPACETIME API/BUYER/Item Details/textlabevalue_SubTotalPrice'))

WebUI.verifyEqual(fsubtotal1, asubtotal, FailureHandling.CONTINUE_ON_FAILURE)
