...
WebUI.verifyElementText(findTestObject('SUPERBABY/BUYER/Payment Page/textlabelvalue_InvoiceNo'), invoiceTmp.text, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementText(findTestObject('SUPERBABY/BUYER/Payment Page/textlabel_SubTotal01'), fsubtotalTmp.text, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementText(findTestObject('SUPERBABY/BUYER/Payment Page/textlabel_Total'), totalTmp.text, FailureHandling.CONTINUE_ON_FAILURE)
