...
if (itemVariants == 'yes') {
    ...
    def itemPrice = WebUI.getText(findTestObject('CONSUMER/Item Details Page/Variants/textlabel_itemPrice'))
...
WebUI.verifyOptionSelectedByLabel(findTestObject('SUPERBABY/SELLER/Purchase Order list (B2C)/dropdown_OrderStatus'), orderstatus, 
    false, 0)
