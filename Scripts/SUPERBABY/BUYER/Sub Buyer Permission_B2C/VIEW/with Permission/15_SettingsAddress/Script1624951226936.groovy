...
WebUI.waitForElementVisible(findTestObject('CONSUMER/Settings/textfield_FirstName'), 0)

WebUI.verifyElementPresent(findTestObject('CONSUMER/Settings/textfield_FirstNameAddress'), 0)
