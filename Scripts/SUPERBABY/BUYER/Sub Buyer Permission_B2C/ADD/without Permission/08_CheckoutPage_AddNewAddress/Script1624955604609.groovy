...
WebUI.waitForElementVisible(findTestObject('SUPERBABY/BUYER/One Page Requisition/button_AddNewAddress'), 0)

WebUI.verifyElementPresent(findTestObject('SUPERBABY/BUYER/One Page Requisition/button_AddNewAddress'), 0)

WebUI.verifyElementNotClickable(findTestObject('SUPERBABY/BUYER/One Page Requisition/button_AddNewAddress'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementNotClickable(findTestObject('SUPERBABY/BUYER/One Page Requisition/button_AddNewBillingAddress'), FailureHandling.STOP_ON_FAILURE)
