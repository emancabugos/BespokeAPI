...
WebUI.verifyElementNotClickable(findTestObject('CONSUMER/Evaluation List/button_Add New List'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('CONSUMER/Evaluation List/button_Add New List'), FailureHandling.STOP_ON_FAILURE)
