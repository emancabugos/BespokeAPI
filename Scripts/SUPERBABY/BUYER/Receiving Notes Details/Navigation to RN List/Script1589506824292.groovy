...
WebUI.click(findTestObject('SUPERBABY/BUYER/Buyer Sidebar/linktext_Receiving Notes'))

WebUI.waitForElementVisible(findTestObject('SUPERBABY/BUYER/Receiving Notes List/textlabel_ReceivingNotesList'), 0)
