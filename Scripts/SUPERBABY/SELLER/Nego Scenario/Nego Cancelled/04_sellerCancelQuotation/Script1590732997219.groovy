...
WebUI.waitForElementVisible(findTestObject('SUPERBABY/SELLER/Quotation Details/button_Cancel Quotation'), 0)

WebUI.click(findTestObject('SUPERBABY/SELLER/Quotation Details/button_Cancel Quotation'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('SUPERBABY/SELLER/Quotation Details/Cancel Popup/button_okay'), 0)

WebUI.click(findTestObject('SUPERBABY/SELLER/Quotation Details/Cancel Popup/button_okay'), FailureHandling.CONTINUE_ON_FAILURE)
