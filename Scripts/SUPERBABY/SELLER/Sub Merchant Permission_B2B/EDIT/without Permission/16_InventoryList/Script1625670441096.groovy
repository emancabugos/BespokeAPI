...
WebUI.verifyElementVisible(findTestObject('MERCHANT_UPDATE/Inventory/icon icon-edit'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('MERCHANT_UPDATE/Inventory/icon icon-edit'), FailureHandling.STOP_ON_FAILURE)
