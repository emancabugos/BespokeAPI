...
WebUI.verifyElementClickable(findTestObject('CONSUMER/User Custom Fields/upload_Admin_Image_ConsMer_No'))
...
WebUI.verifyElementClickable(findTestObject('CONSUMER/User Custom Fields/upload_Admin_Image_ConsMer_Yes'))
...
WebUI.verifyElementClickable(findTestObject('CONSUMER/User Custom Fields/upload_Admin_PDF_ConsMer_No'))
...
WebUI.verifyElementClickable(findTestObject('CONSUMER/User Custom Fields/upload_Admin_PDF_ConsMer_Yes'))
