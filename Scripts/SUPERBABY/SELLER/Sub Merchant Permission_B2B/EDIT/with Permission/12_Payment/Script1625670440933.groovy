...
WebUI.verifyElementClickable(findTestObject('MERCHANT/User Settings/Payment/COD/button_link account'))
...
WebUI.verifyElementClickable(findTestObject('MERCHANT/User Settings/Payment/custom/button_link custom'))
...
WebUI.verifyElementClickable(findTestObject('MERCHANT/User Settings/Payment/offline/button_link offline'))
...
WebUI.verifyElementClickable(findTestObject('MERCHANT/User Settings/Payment/stripe/button_link stripe'))
