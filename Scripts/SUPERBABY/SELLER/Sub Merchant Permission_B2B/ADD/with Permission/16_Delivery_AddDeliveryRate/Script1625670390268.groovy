...
WebUI.verifyElementVisible(findTestObject('MERCHANT/Delivery Settings/Add Delivery Option/Delivery Rate/button_Add Delivery Rate'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('MERCHANT/Delivery Settings/Add Delivery Option/Delivery Rate/button_Add Delivery Rate'), 
    FailureHandling.STOP_ON_FAILURE)
