...
WebUI.setText(findTestObject('SUPERBABY/SELLER/Create Invoice/textbox_invoice ref'), 'ALPHA1234 $P3(!@~')

WebUI.verifyElementAttributeValue(findTestObject('SUPERBABY/SELLER/Create Invoice/textbox_invoice ref'), 'value', 'ALPHA1234 $P3(!@~', 
    0)

WebUI.comment('White SPACE')

WebUI.setText(findTestObject('SUPERBABY/SELLER/Create Invoice/textbox_invoice ref'), '                                     ')
