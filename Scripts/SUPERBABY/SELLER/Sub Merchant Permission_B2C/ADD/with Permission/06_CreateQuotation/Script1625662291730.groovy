...
WebUI.click(findTestObject('SUPERBABY/SELLER/Create Quotation/button_CreateQuotation'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('SPACETIME API/MERCHANT/Create Quotation/datepicker_ValidDate'), 0)

WebUI.verifyElementVisible(findTestObject('SPACETIME API/MERCHANT/Create Quotation/linktext_AddNewLine'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('SPACETIME API/MERCHANT/Create Quotation/linktext_AddNewLine'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('You need permission to perform this action', false)

WebUI.verifyElementVisible(findTestObject('SPACETIME API/MERCHANT/Create Quotation/button_Send'), FailureHandling.STOP_ON_FAILURE)

WebUI.mouseOver(findTestObject('SPACETIME API/MERCHANT/Create Quotation/button_Send'), FailureHandling.STOP_ON_FAILURE)
