...
WebUI.verifyElementPresent(findTestObject('CONSUMER/Evaluation Widget/button_Edit'), 0)

WebUI.verifyElementNotClickable(findTestObject('CONSUMER/Evaluation Widget/button_Edit'), FailureHandling.STOP_ON_FAILURE)
