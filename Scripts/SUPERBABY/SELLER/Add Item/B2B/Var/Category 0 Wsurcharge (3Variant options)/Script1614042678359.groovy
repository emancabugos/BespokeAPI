...
WebUI.setText(findTestObject('MERCHANT_UPDATE/Create New Listing_Variants/textfield_Item Description'), 'Description01')
...
WebUI.setText(findTestObject('MERCHANT_UPDATE/Create New Listing_Variants/textfield_Price'), '100')

WebUI.comment('SKU')

WebUI.waitForElementVisible(findTestObject('MERCHANT_UPDATE/Create New Listing_Variants/textfield_SKU'), 0)

WebUI.setText(findTestObject('MERCHANT_UPDATE/Create New Listing_Variants/textfield_SKU'), 'SKU001')
