...
WebUI.setText(findTestObject('MERCHANT_UPDATE/Create New Listing_Variants/textfield_Listing Name'), ('ITEM DISABLE SELLER' + 
...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Price/PH'), '1600.75')

WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Price/SG'), '1600.75')

WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Price/MY'), '1600.75')
