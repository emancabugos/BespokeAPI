...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Purchase Order Sub Buyer')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Production Sub Buyer')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Shipping Sub Buyer')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Finance Sub Buyer')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Certification Sub Buyer')
