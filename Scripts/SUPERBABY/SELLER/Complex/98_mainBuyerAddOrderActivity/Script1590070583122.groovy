...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Purchase Order Main Buyer')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Production Main Buyer')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Shipping Main Buyer')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Finance Main Buyer')
...
WebUI.setText(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textfield_Event'), 'Certification Main Buyer')
