...
WebUI.click(findTestObject('SUPERBABY/SELLER/Invoice List/row1_invoice'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('SUPERBABY/SELLER/Invoice Details/textlabel_Invoice'), 0)
