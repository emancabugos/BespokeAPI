...
WebUI.click(findTestObject('SUPERBABY/ADMIN/New Item List/Dropdown Filter/Category/category2'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('SUPERBABY/ADMIN/New Item List/Dropdown Filter/Category/category1'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('SUPERBABY/ADMIN/New Item List/Dropdown Filter/Category/category2'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementNotChecked(findTestObject('SUPERBABY/ADMIN/New Item List/Dropdown Filter/Category/category1'), 0)

WebUI.verifyElementNotChecked(findTestObject('SUPERBABY/ADMIN/New Item List/Dropdown Filter/Category/category2'), 0)
