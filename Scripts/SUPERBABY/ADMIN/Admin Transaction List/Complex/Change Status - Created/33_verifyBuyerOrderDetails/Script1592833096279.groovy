...
WebUI.waitForElementPresent(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textlabelValue_OrderStatus'), 0)

WebUI.verifyOptionSelectedByLabel(findTestObject('SUPERBABY/BUYER/Purchase Order Details (B2B)/textlabelValue_OrderStatus'), 
    'Created', false, 0)
