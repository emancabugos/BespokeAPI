...
WebUI.setText(findTestObject('SUPERBABY/ADMIN/Purchase Order List B2B/textlabel_PRTimestamp'), '')
...
WebUI.click(findTestObject('SUPERBABY/ADMIN/Purchase Order List B2B/dropdown_Supplier'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('SUPERBABY/ADMIN/Purchase Order List B2B/a_AllMerchantDD/checkbox_MerchantSelectAll'), 
    0)

WebUI.click(findTestObject('SUPERBABY/ADMIN/Purchase Order List B2B/a_AllMerchantDD/checkbox_Supplier1'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('SUPERBABY/ADMIN/Purchase Order List B2B/dropdown_PRStatus'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('SUPERBABY/ADMIN/Purchase Order List B2B/a_PRStatusDD/checkbox_PRSelectAll'), 
    0)

WebUI.click(findTestObject('SUPERBABY/ADMIN/Purchase Order List B2B/a_PRStatusDD/checkbox_PRApproved'), FailureHandling.STOP_ON_FAILURE)
