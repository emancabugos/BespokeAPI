...
WebUI.verifyElementPresent(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_EmailTemplate'), 0)

WebUI.verifyElementPresent(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_MailLog'), 0)
