...
WebUI.waitForElementPresent(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_CustomCode'), 0)

WebUI.click(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_CustomCode'), FailureHandling.CONTINUE_ON_FAILURE)
