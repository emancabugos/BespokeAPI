...
WebUI.waitForElementPresent(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_MailLog'), 0)

WebUI.click(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_MailLog'), FailureHandling.CONTINUE_ON_FAILURE)
