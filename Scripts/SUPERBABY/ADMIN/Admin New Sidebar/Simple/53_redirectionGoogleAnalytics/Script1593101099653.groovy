...
WebUI.waitForElementPresent(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_GoogleAnalytics'), 0)

WebUI.click(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_GoogleAnalytics'), FailureHandling.CONTINUE_ON_FAILURE)
