...
WebUI.waitForElementPresent(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_ActivityLog'), 0)

WebUI.click(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_ActivityLog'), FailureHandling.CONTINUE_ON_FAILURE)
