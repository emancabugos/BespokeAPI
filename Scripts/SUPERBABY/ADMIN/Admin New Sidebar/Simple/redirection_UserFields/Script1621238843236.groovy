...
WebUI.waitForElementPresent(findTestObject('ADMIN/New Sidebar Menu/span_User Fields'), 0)

WebUI.click(findTestObject('ADMIN/New Sidebar Menu/span_User Fields'), FailureHandling.CONTINUE_ON_FAILURE)
