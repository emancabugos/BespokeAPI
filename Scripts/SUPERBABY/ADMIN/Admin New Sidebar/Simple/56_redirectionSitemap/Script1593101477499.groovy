...
WebUI.waitForElementPresent(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_Sitemap'), 0)

WebUI.click(findTestObject('SUPERBABY/ADMIN/Admin New Sidebar/submenu_Sitemap'), FailureHandling.CONTINUE_ON_FAILURE)
