...
WebUI.callTestCase(findTestCase('Utilities/MERCHANT/Merchant Login Private'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('MERCHANT/Delivery Settings/Add Delivery Option/dropdowntxtfield_Delivers to'), country)

countryval = WebUI.getAttribute(findTestObject('MERCHANT/Delivery Settings/Add Delivery Option/dropdowntxtfield_Delivers to'), 
    'value')

KeywordLogger log = new KeywordLogger()

log.logInfo(countryval)

WebUI.waitForElementVisible(findTestObject('MERCHANT/Delivery Settings/Add Delivery Option/checkbox_country'), 0)

String countryabv = WebUI.getAttribute(findTestObject('MERCHANT/Delivery Settings/Add Delivery Option/checkbox_country'), 
    'value')

log.logInfo(countryabv)
