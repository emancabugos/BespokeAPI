...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/searchbar_country'), 'Phil')

WebUI.waitForElementVisible(findTestObject('MERCHANT/Upload Item Page/Country/PH'), 0)

WebUI.verifyElementText(findTestObject('MERCHANT/Upload Item Page/Country/PH'), 'Philippines')
