...
WebUI.waitForElementVisible(findTestObject('MERCHANT_UPDATE/Location ID/Pricing and Stocks/button_Bulk Pricing'), 0)

WebUI.click(findTestObject('MERCHANT_UPDATE/Location ID/Pricing and Stocks/button_Bulk Pricing'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('MERCHANT_UPDATE/Location ID/Pricing and Stocks/value_bulk pricing'), 0)

WebUI.verifyElementText(findTestObject('MERCHANT_UPDATE/Location ID/Pricing and Stocks/value_bulk pricing'), '401 - 500')
