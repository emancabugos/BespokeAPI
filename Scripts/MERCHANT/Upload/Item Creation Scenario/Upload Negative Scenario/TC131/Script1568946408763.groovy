...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_listing-name'), 'TC131')
...
WebUI.verifyElementPresent(findTestObject('MERCHANT/Upload Item Page/Item Upload/Toaster Message/error_no delivery'), 0)

WebUI.verifyElementNotPresent(findTestObject('MERCHANT/Upload Item Page/Item Upload/Toaster Message/error_no delivery'), 
    0)
