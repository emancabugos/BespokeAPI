...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_listing-name'), 'TC122')
...
WebUI.verifyElementNotPresent(findTestObject('MERCHANT/Upload Item Page/Item Upload/Image/icon_delete'), 0)
