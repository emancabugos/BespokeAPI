...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_listing-name'), 'TC129')
...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_price'), '')
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_price'), 'value', '', 0)
