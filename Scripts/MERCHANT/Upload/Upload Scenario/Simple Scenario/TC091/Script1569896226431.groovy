...
WebUI.verifyElementPresent(findTestObject('MERCHANT/Upload Item Page/Item Upload/Country Search/1st country'), 0)

WebUI.click(findTestObject('MERCHANT/Upload Item Page/Item Upload/searchbar_country'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('MERCHANT/Upload Item Page/Item Upload/Country Search/select none'), FailureHandling.CONTINUE_ON_FAILURE)
