...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_price'), '100ABC')

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_price'), 'value', '100', 
    0)
