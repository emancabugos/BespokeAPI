...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_price'), '100.69')

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_price'), 'value', '100.69', 
    0)
