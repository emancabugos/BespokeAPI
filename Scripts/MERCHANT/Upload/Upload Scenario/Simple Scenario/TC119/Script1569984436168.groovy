...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_Stocks'), '69')

WebUI.click(findTestObject('MERCHANT/Upload Item Page/Item Upload/checkbox_unlimited'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Upload Item Page/Item Upload/textbox_Stocks'), 'value', '69', 
    0)
