...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/radiobutton_Fixed price'), 0)
...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_range_start'), 0)

WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_range_start'), '100')

WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_range_end'), '250')

WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/input_rate_cost'), '3000')
...
WebUI.verifyElementPresent(findTestObject('MERCHANT/Upload Item Page/Item Upload/Toaster Message/discount cant be more'), 
    0)
