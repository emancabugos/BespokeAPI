...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/Delete/button_Okay'), 0)
...
WebUI.verifyElementNotPresent(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/Delete/onwards will get'), 0)
