...
WebUI.click(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/Delete/button_Cancel'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(1, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/Delete/onwards will get'), 0)
