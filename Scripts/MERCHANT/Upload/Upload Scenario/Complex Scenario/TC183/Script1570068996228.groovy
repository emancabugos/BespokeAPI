...
WebUI.setText(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/purchase_onwards'), '1')
...
WebUI.waitForElementVisible(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/Delete/button_delete'), 0)

WebUI.click(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/Delete/button_delete'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/Delete/textlabel_Are you sure want to delete'), 
    0)

WebUI.click(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/Delete/button_Okay'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementClickable(findTestObject('MERCHANT/Upload Item Page/Edit Bulk Pricing/radiobutton_Onwards'), FailureHandling.CONTINUE_ON_FAILURE)
