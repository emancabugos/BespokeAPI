...
'Verify each edited item will set to No'
...
WebUI.waitForElementAttributeValue(findTestObject('ADMIN/User Mgmt/Items/linktext_itemName'), 'name', varListingName, 0)

WebUI.click(findTestObject('ADMIN/User Mgmt/Items/item_toggleButton'))

WebUI.waitForElementVisible(findTestObject('ADMIN/User Mgmt/Items/toaster_popup'), 0)

WebUI.callTestCase(findTestCase('Utilities/MERCHANT/Logout'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('Utilities/MERCHANT/Merchant Login Private'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('MERCHANT/Headers/linktext_Inventory'), 0)

WebUI.click(findTestObject('MERCHANT/Headers/linktext_Inventory'))
...
WebUI.click(findTestObject('MERCHANT/Inventory Page/Item Details/textlabel_item name'))
...
WebUI.scrollToElement(findTestObject('MERCHANT/Upload Item Page/Item Upload/button_Upload Now'), 0)
